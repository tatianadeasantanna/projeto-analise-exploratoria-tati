...
![Print do Painel 1 - Análise Geral](dashboard_panel_1.png)

## Painel 2 - Análise Temporal das Cidades do Sudeste

![Print do Painel 2 - Análise Temporal](dashboard_panel_2.png)

### Repositório
O repositório do projeto completo está no [GitHub](https://github.com/tatianadeasantanna/projeto-analise-exploratoria-tati/).
